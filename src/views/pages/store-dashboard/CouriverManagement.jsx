  ...
  const fetchFlorists = async () => {
    try {
      ...
      const activeResponse = await axios.get(
        `https://customchainflower-ecbrb4bhfrguarb9.southeastasia-01.azurewebsites.net/api/employees/storeId-courier-status-true?storeid=${storeId}`,
        {
      ...
      const pendingResponse = await axios.get(
        `https://customchainflower-ecbrb4bhfrguarb9.southeastasia-01.azurewebsites.net/api/employees/storeId-courier-status-false?storeid=${storeId}`,
        {
          headers: { Authorization: `Bearer ${token}` }
        }
      );
                  ...
                  <Box sx={{ mt: 3 }}>
                    ...
                    <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2 }}>
                      <Box>
                        ...
                        <Typography>{viewDetail.florist.numberMoto}</Typography>
                      </Box>
                      ...
                      <Box>
                        ...
                        <Typography>{viewDetail.florist.colorMoto}</Typography>
                      </Box>
                      ...
                      <Box>
                        ...
                        <Typography>{viewDetail.florist.motoType}</Typography>
                      </Box>
                    </Box>
                  </Box>
                </Box>
